...
prop_motion_team |> 
  ...
  geom_bar(stat = "identity") +
  geom_hline(yintercept = 0.6618385, linetype = "dashed", color = "black", size = 1) +
  theme_bw() +
...
team_prop_motion_from_line |> 
  ...
  geom_bar(stat = "identity") +
  geom_hline(yintercept = 0.1198928, linetype = "dashed", color = "black", size = 1) +
  theme_bw() +
  theme(axis.text.x = element_text(size = 8.5), legend.position = "none", plot.title = element_text(hjust = 0.5, face = "bold", size = 14), axis.title = element_text(face = "bold", size = 10), axis.text = element_text(face = "bold", angle = 90)) +
  labs(
...
team_prop_motion |> 
  ...
  geom_bar(stat = "identity") +
  geom_hline(yintercept = 0.1096526, linetype = "dashed", color = "black", size = 1) +
  theme_bw() +
