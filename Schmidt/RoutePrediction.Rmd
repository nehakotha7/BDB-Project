...
#### Proportion of Plays Where A Player Was Motioned ----------------

##### Entire League 
```{r}
motion_plays <- plays_of_route_runners |>
...
#### Motion from the line of scrimmage -------------

##### WR that motioned from the line of scrimmage (excludes players that were not set at the line)
```{r}
...
##### Teams motioning players from line of scrimmage
```{r}
# the proportion of the times each player motioned when they were set at the line
...
#### Motion and stay in motion at snap ------------------------

##### WR that were still in motion at snap if they motioned at some point (excludes players that were not in motion prior to snap)
```{r}
...
##### Teams motioning players and keeping them in motion at snap
```{r}
...
team_prop_motion |> 
  ...
  labs(
    title = "Proportion of Players Each NFL Team Motions & Keeps In Motion At Snap ",
    x = "NFL Team",
    y = "Prop of Players That Motion And Stay in Motion Per Team"
  )
```
