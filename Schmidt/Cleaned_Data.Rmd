...
fixing_receivers <- function(data, t, l, r, num) {
  data |> 
...
# All 27 plays with 1 receiver on each side had WR or TE in the 1 position
left_receivers <- fixing_receivers(messed_up_left, 2, 1, 1, 1) 

  
## NEED TO FIX THIS PART!!! 
total_two_left_one_plays_fixed <- messed_up_left |> 
  full_join(left_receivers) |> 
...
total_two_left_one_plays_fixed |> 
  filter(num_receivers_left + num_receivers_right == total_receivers_in_alignment) |> 
  distinct(gameId, playId)
