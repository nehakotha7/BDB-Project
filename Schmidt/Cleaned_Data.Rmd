...
# 10,956 plays completely finished 
finished_plays |> 
  distinct(gameId, playId)
```
...
too_many_receivers_week1 <- inner_join(tracking_week1, too_many_receivers_playdID(tracking_week1))

too_many_receivers_week2 <- inner_join(tracking_week2, too_many_receivers_playdID(tracking_week2)) 

too_many_receivers_week3 <- inner_join(tracking_week3, too_many_receivers_playdID(tracking_week3))

too_many_receivers_week4 <- inner_join(tracking_week4, too_many_receivers_playdID(tracking_week4))

too_many_receivers_week5 <- inner_join(tracking_week5, too_many_receivers_playdID(tracking_week5))

too_many_receivers_week6 <- inner_join(tracking_week6, too_many_receivers_playdID(tracking_week6))

too_many_receivers_week7 <- inner_join(tracking_week7, too_many_receivers_playdID(tracking_week7))

too_many_receivers_week8 <- inner_join(tracking_week8, too_many_receivers_playdID(tracking_week8))

too_many_receivers_week9 <- inner_join(tracking_week9, too_many_receivers_playdID(tracking_week9))
```
...
# there are 2,231 distinct plays
...
too_many_receiver_plays |> 
  filter(frameType == "SNAP",
         receiver_in_left_alignment == TRUE | receiver_in_right_alignment == TRUE,
         !is.na(routeRan)) |> 
  count(gameId, playId, total_receivers_in_alignment) |> # The number of receivers in alignment that ran a route 
  filter(n == total_receivers_in_alignment)
```
...
messed_up_right_plays <- anti_join(too_many_receiver_plays, messed_left_up) 

messed_up_left_plays <- inner_join(too_many_receiver_plays, messed_left_up) 
```
...
not_enough_receivers_week1 <- inner_join(tracking_week1, not_enough_receivers_playdID(tracking_week1))

not_enough_receivers_week2 <- inner_join(tracking_week2, not_enough_receivers_playdID(tracking_week2)) 

not_enough_receivers_week3 <- inner_join(tracking_week3, not_enough_receivers_playdID(tracking_week3))

not_enough_receivers_week4 <- inner_join(tracking_week4, not_enough_receivers_playdID(tracking_week4))

not_enough_receivers_week5 <- inner_join(tracking_week5, not_enough_receivers_playdID(tracking_week5))

not_enough_receivers_week6 <- inner_join(tracking_week6, not_enough_receivers_playdID(tracking_week6))

not_enough_receivers_week7 <- inner_join(tracking_week7, not_enough_receivers_playdID(tracking_week7))

not_enough_receivers_week8 <- inner_join(tracking_week8, not_enough_receivers_playdID(tracking_week8))

not_enough_receivers_week9 <- inner_join(tracking_week9, not_enough_receivers_playdID(tracking_week9))
```
...
# there are 1,271 distinct plays
not_enough_receiver_plays |> 
  distinct(gameId, playId)

# Note there is currently a total of 3,690 incorrect and 10,956 plays correct; total 14,646 plays
```
