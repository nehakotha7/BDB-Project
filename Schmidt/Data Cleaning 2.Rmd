...
adding_player_x_position <- function(week_num){
  ...
  mutate(yardlines_to_go = ifelse(playDirection == "left" & frameType == "SNAP", round(x - 10), NA),
         ...
         yardlines_to_go = ifelse(playDirection == "right" & frameType == "SNAP", 100 - round(x - 10), round(exact_yards_to_go)), 
         exact_yards_to_go = ifelse(playDirection == "right" & frameType == "SNAP", 100 - (x - 10), exact_yards_to_go),
         yardlines_to_go = ifelse(frameType == "SNAP" & yardsTillTouchdown > exact_yards_to_go, yardsTillTouchdown, yardlines_to_go))  # all of these were off by less than a yard
}
